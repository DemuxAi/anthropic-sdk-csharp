...
[JsonConverter(typeof(JsonModelConverter<BetaMessageBatch, BetaMessageBatchFromRaw>))]
public sealed record class BetaMessageBatch : JsonModel
{
    /// <summary>
...
class BetaMessageBatchFromRaw : IFromRawJson<BetaMessageBatch>
{
    /// <inheritdoc/>
