...
[JsonConverter(typeof(JsonModelConverter<SkillRetrieveResponse, SkillRetrieveResponseFromRaw>))]
public sealed record class SkillRetrieveResponse : JsonModel
{
    /// <summary>
...
class SkillRetrieveResponseFromRaw : IFromRawJson<SkillRetrieveResponse>
{
    /// <inheritdoc/>
