...
public sealed record class CitationSearchResultLocationParam : JsonModel
{
...
class CitationSearchResultLocationParamFromRaw : IFromRawJson<CitationSearchResultLocationParam>
{
    /// <inheritdoc/>
